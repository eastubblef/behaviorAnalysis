...
function         [Num100, numelCorVec100, numelIncorVec100, numIncorrPriors100, percIncorrPriors100ofIncorr100, Num200, numelCorVec200, numelIncorVec200, numIncorrPriors200, percIncorrPriors200ofIncorr200, Num400, numelCorVec400, numelIncorVec400, numIncorrPriors400, percIncorrPriors400ofIncorr400,...
...
% this m file details the rxn time bins & outputs #trials per bin & performance 
...
hundredInds = find(rxSort1 <= binwidth100);         %indices of trials with super fast rxn times
rxSort100 = rxSort1(hundredInds);
corVec100 = mu(hundredInds);
yes100 = find(corVec100 ~= 0);                      %correct trials
...
numelIncorVec100 = numelCorVec100 - numel(yes100);  %number of incorrect trials 

%These are incorr trials in which they chose the previously rewarded side on 1 prior back
rxSortPrior100 = rxSort4(hundredInds);
numIncorrPriors100 = numel(find(isfinite(rxSortPrior100)));
if numelIncorVec100 > 0
    percIncorrPriors100ofIncorr100 = (numIncorrPriors100/numelIncorVec100)*100;
else if numelIncorVec100 == 0
        percIncorrPriors100ofIncorr100 = NaN;
    end
end   %To adjust for 0/0, which would erronously give NaN*100% instead of NaN
...
numelIncorVec200 = numelCorVec200 - numel(yes200);  %number of incorrect trials 


%These are incorr trials in which they chose the previously rewarded side on 1 prior back
rxSortPrior200 = rxSort4(twoHunInds);
numIncorrPriors200 = numel(find(isfinite(rxSortPrior200)));
if numelIncorVec200 > 0
    percIncorrPriors200ofIncorr200 = (numIncorrPriors200/numelIncorVec200)*100;
else if numelIncorVec200 == 0
        percIncorrPriors200ofIncorr200 = NaN;
    end
end
...
numelIncorVec400 = numelCorVec400 - numel(yes400);  %number of incorrect trials 

%These are incorr trials in which they chose the previously rewarded side on 1 prior back
rxSortPrior400 = rxSort4(fourHunInds);
numIncorrPriors400 = numel(find(isfinite(rxSortPrior400)));
if numelIncorVec400 > 0
    percIncorrPriors400ofIncorr400 = (numIncorrPriors400/numelIncorVec400)*100;
else if numelIncorVec400 == 0
     percIncorrPriors400ofIncorr400 = NaN;
    end
end
...
numelIncorVec600 = numelCorVec600 - numel(yes600);    %number of incorrect trials 

%These are incorr trials in which they chose the previously rewarded side on 1 prior back
rxSortPrior600 = rxSort4(sixHunInds);
numIncorrPriors600 = numel(find(isfinite(rxSortPrior600)));
if numelIncorVec600 > 0
    percIncorrPriors600ofIncorr600 = (numIncorrPriors600/numelIncorVec600)*100;
else if numelIncorVec600 == 0
        percIncorrPriors600ofIncorr600 = NaN;
    end
end
...
numelIncorVec1000 = numelCorVec1000 - numel(yes1000);  %number of incorrect trials 

%These are incorr trials in which they chose the previously rewarded side on 1 prior back
rxSortPrior1000 = rxSort4(thouInds);
numIncorrPriors1000 = numel(find(isfinite(rxSortPrior1000)));
if numelIncorVec1000 > 0
    percIncorrPriors1000ofIncorr1000 = (numIncorrPriors1000/numelIncorVec1000)*100;
else if numelIncorVec1000 == 0
        percIncorrPriors1000ofIncorr1000 = NaN;
    end
end
...
numelIncorVec1100 = numelCorVec1100 - numel(yes1100);  %number of incorrect trials 

%These are incorr trials in which they chose the previously rewarded side on 1 prior back
rxSortPrior3000 = rxSort4(thouoneInds);
numIncorrPriors3000 = numel(find(isfinite(rxSortPrior3000)));
% percIncorrPriors3000ofTot3000 = (numIncorrPriors3000/numelCorVec1100);
if numelIncorVec1100 > 0
    percIncorrPriors3000ofIncorr3000 = (numIncorrPriors3000/numelIncorVec1100)*100;
else if numelIncorVec1100 == 0        
        percIncorrPriors3000ofIncorr3000 = NaN;
    end
end
% 
