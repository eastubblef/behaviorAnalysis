...
% function [taskbase] = behaveLoad5history_blocks(fileDirectory)
function [Prob_Li, Prob_LiMinusOne1, Prob_LiMinusTwo1, Prob_LiMinusThree1, Prob_LiMinusFour1, Prob_LiMinusFive1, Prob_LiMinusSix1, Prob_LiMinusSeven1] = behaveLoad5history_blocks(fileDirectory)
