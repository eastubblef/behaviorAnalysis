...
% %     y = [Prob_Li, Prob_Li, Prob_Li, Prob_Li, Prob_Li, Prob_Li, Prob_Li, Prob_Li];
    h = plot(y, 'k.', 'MarkerSize', 18);
...
%         clear i;
%         var1 = i;
%      xlabels2 = [var1, var1-1, var1-2, var1-3', var1-4', var1-5', var1-6', var1-7'];
