...
function [taskbase] = behaveLoad5(fileDirectory)
...
% fileDirectory = '/Users/stubblefielde/Desktop/behaviorFebMarApr16/Vgatfour/forAnalysis';
...
if numel(trialEndTimes) < numel(trialStartTimes)
    ...
    trialStartTimesNew = trialStartTimes;
end
...
taskbase.trialEndTimes = trialEndTimes'; %new
