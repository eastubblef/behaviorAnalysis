...
%Updated 1.17.18 for mean overlay - doesn't really fit, though. 
%See plotsPerformance3.m for better mean plotting
...
p = plot(performMat1two(:,3), performMat1two(:,2), 'y', 'LineWidth', 2);
...
plot(performMat3(:,1), performMat3(:,2), 'm', 'LineWidth', 2);
...
performMatNew2_2 = performMat1two(:,2); %correct for different sized vectors & diff training day starts
performMatNew2_3 = performMat1two(:,3);
for i = 1:length(performMatNew2_3)
    if performMatNew2_3(i) == performMatNew2_3(end)
        break
    else if performMatNew2_3(i+1) == performMatNew2_3(i) + 1
            performMat4avg2(i) = performMatNew2_2(i);
        else
            performMat4avg2(i) = NaN;   %correct for different sized vectors & diff training day starts
        end
    end
end
performMat4avg2 = performMat4avg2';

performMatNew3_2 = performMat3(:,2);
performMatNew3_1 = performMat3(:,1);
for i = 1:length(performMatNew3_1)
    if performMatNew3_1(i) == performMatNew3_1(end)
        break
    else if performMatNew3_1(i+1) == performMatNew3_1(i) + 1
            performMat4avg3(i) = performMatNew3_2(i);
        else performMat4avg3(i) = NaN;
        end
    end
end
performMat4avg3 = performMat4avg3';

performMatNew5_2 = performMat5(:,2);
performMatNew5_1 = performMat5(:,1);
for i = 1:length(performMatNew5_1)
    if performMatNew5_1(i) == performMatNew5_1(end)
        break
    else if performMatNew5_1(i+1) == performMatNew5_1(i) + 1
            performMat4avg5(i) = performMatNew5_2(i);
        else
            performMat4avg5(i) = NaN;
        end      
    end
end
performMat4avg5 = performMat4avg5';
...
for i = 1:length(performMatNew2two_3)
    if performMatNew2two_3(i) == performMatNew2two_3(end)
        break
    else if performMatNew2two_3(i+1) == performMatNew2two_3(i) + 1
            performMat4avg2two(i) = performMatNew2two_2(i);
        else
            performMat4avg2two(i) = NaN;   %correct for different sized vectors & diff training day starts
        end
    end
end
performMat4avg2two = performMat4avg2two';

performMatNew4_1 = performMat4(:,1);
performMatNew4_2 = performMat4(:,2);
for i = 1:length(performMatNew4_1)
    if performMatNew4_1(i) == performMatNew4_1(end)
        break
    else if performMatNew4_1(i+1) == performMatNew4_1(i) + 1
            performMat4avg4(i) = performMatNew4_2(i);
        else performMat4avg4(i) = NaN;
        end
    end
end
performMat4avg4 = performMat4avg4';

performMatNew6_2 = performMat6(:,2);
performMatNew6_1 = performMat6(:,1);
for i = 1:length(performMatNew6_1)
    if performMatNew6_1(i) == performMatNew6_1(end)
        break
    else if performMatNew6_1(i+1) == performMatNew6_1(i) + 1
            performMat4avg6(i) = performMatNew6_2(i);
        else
            performMat4avg6(i) = NaN;
        end      
    end
end
performMat4avg6 = performMat4avg6';
