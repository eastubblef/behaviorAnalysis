...
performMat4avg2 = flip(performMatNew2_2);

performMatNew3_2 = performMat3(:,2);
performMatNew3_1 = performMat3(:,1);
performMat4avg3 = flip(performMatNew3_2);

performMatNew5_2 = performMat5(:,2);
performMatNew5_1 = performMat5(:,1);
performMat4avg5 = flip(performMatNew5_2); % Align performance vecs from the last session:
...
performMatBlk = flip(performMatBlk,1);
