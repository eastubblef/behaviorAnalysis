...
%% Josh additionally suggested number of trials of ea. perform/rxn time bin
...
sumRxNumPriors = sum(rxPriors);  %total trials mouse moved in prev. rew dir
...
for m = 1:length(sumRxNumTrials)
    NumPriorsPercOfIncor(m) = (sumRxNumPriors(m)/sumCatNumIncorVec_all) * 100;
end
