...
%% Fill a new matrix of rx times:   col 6: CL = -1; CR = 1; IL = 0; IR = 0; Keep negative Rx times (?)
...
%     if rxTimeL(w) < 0;
% %         rxMat(w,2) = NaN;
%         rxMat(w,2) = -0.5;  % CL trials w/ negative rx times
%     else
...
%     if rxTimeR(x) < 0;
% %         rxMat(x,3) = NaN;
%         rxMat(w,3) = 0.5;   % CR trials w/ negative rx times
%     else
...
%     if rxTimeIL(y) < 0
% %         rxMat(y,4) = NaN;
%         rxMat(y,4) -0.55;   % IL trials w/ negative rx times
%     else
...
%     if rxTimeIR(z) < 0
% %         rxMat(z,5) = NaN;
%         rxMat(z,5) = 0.55;  % IR trials w/ negative rx times
% 
%     else
...
[pDist,hDist,statsDist] = ranksum(stimMat2, noStimMat2);        %be sure these are not just the corrects
