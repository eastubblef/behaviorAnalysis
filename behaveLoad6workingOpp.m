...
function [taskbase] = behaveLoad6workingOpp(fileDirectory, removeLongTrials, excludeTrials)
...
% fileDirectory = '/Volumes/My Passport for Mac/171013/behaveNewUnits';
% filenamestr = 'SC6';

fileDirectory = '/Users/stubblefielde/Desktop/behaviorFebMarAprMay16/SC7';
filenamestr = 'SC7';

% fileDirectory = '/Users/stubblefielde/Desktop/behaviorFebMarAprMay16/SC2';
% filenamestr = 'SC2';
% 
% fileDirectory = '/Volumes/My Passport for Mac/Vgatfive/170118/behaveNewUnits';
% fileDirectory = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings16_17/170111';
% filenamestr = 'Vgatfive';

% fileDirectory = '/Users/stubblefielde/Desktop/behaviorFebMarAprMay16/SC8';
% filenamestr = 'SC8';
...
taskbase.rxCondensed = rxCondensed;  %col 2 holds all rx times
