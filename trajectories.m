...
subplot(2,2,1);
plot(contraNoStimTrajMat(:,1:20), contraNoStimRelTime(1:end,1:20), 'k', 'LineWidth',1);
...
plot(contraStimTrajMat(:,1:20), contraStimRelTime(1:end,1:20), 'bl', 'LineWidth',1);
...
figure; hold on;
subplot(2,2,1); 
plot(ipsiNoStimTrajMat(:,1:20), ipsiNoStimRelTime(1:end,1:20), 'k', 'LineWidth',1);
xlabel('position'); ylabel('ms from trial start');
set(gca, 'Ylim', [0 1000], 'Xlim', [-450 450], 'Ytick', [0:100:1000]);
    mouseInfo = strcat('trial 1:20;should-ipsi NOstim', ',', mouseName, ',', num2str(numSession));
    title(mouseInfo);
subplot(2,2,2); 
plot(ipsiStimTrajMat(:,1:20), ipsiStimRelTime(1:end,1:20), 'bl', 'LineWidth',1);
xlabel('position'); ylabel('ms from trial start');
set(gca, 'Ylim', [0 1000], 'Xlim', [-450 450], 'Ytick', [0:100:1000]);
    mouseInfo = strcat('trial 1:20;should-ipsi +stim');
    title(mouseInfo);
subplot(2,2,3); 
plot(ipsiNoStimTrajMat(:,21:40), ipsiNoStimRelTime(1:end,21:40), 'k', 'LineWidth',1);
xlabel('position'); ylabel('ms from trial start');
set(gca, 'Ylim', [0 1000], 'Xlim', [-450 450], 'Ytick', [0:100:1000]);
    mouseInfo = strcat('trial 21:40;should-ipsi NOstim');
    title(mouseInfo);
subplot(2,2,4); 
plot(ipsiStimTrajMat(:,21:40), ipsiStimRelTime(1:end,21:40), 'bl', 'LineWidth',1);
xlabel('position'); ylabel('ms from trial start');
set(gca, 'Ylim', [0 1000], 'Xlim', [-450 450], 'Ytick', [0:100:1000]);
